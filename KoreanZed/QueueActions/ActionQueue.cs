...
namespace KoreanZed.QueueActions
{
    ...
    {
        public void EnqueueAction(ActionQueueList list, Func<bool> preCondition, Action comboAction,
            Func<bool> conditionToRemove)
        {
        ...
        public bool ExecuteNextAction(ActionQueueList list)
        {
            if (list.Count > 0)
            {
                ...
                if (list[0].PreConditionFunc.Invoke()) list[0].ComboAction.Invoke();
